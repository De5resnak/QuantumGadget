...
from .views import ProductListView, TrendingProductListView, TVProductListView, WashingMachineProductListView, CleaningEquipmentProductListView, DishwasherProductListView
